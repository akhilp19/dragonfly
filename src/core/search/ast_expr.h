...
struct AstKnnNode {
  AstKnnNode() = default;
  AstKnnNode(uint32_t limit, std::string_view field, OwnedFtVector vec, std::string blob,
...
struct AstVectorRangeNode {
  ...
  AstVectorRangeNode(std::string field, double radius, OwnedFtVector vec, std::string blob,
